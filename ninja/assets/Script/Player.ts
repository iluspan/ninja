...
export default class Player extends cc.Component {
    ...
    private _boxCollider:cc.BoxCollider = null;

    onLoad() {
        this._boxCollider = this.node.getComponent(cc.BoxCollider);
        // this._boxCollider.size.height = 50;
        // this._boxCollider.offset.y = -25;
        this.node.x = 0;
    ...
    onCollisionEnter(other,self) {
        console.log("collider with player enter...");
    }

    onCollisionStay(other,self) {
        console.log("collider with player stay...");
    }

    onCollisionExit() {
        console.log("collier with player exit...");
    }
